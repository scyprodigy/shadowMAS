...
Before proposing new work, also scan
`00_entry/DO-NOT-REDO.compiled.v0.en.md` —
a compiled one-screen list of already-decided, deferred, and
lesson-recorded items, regenerated by `tools/build_rework_guard.py`.
